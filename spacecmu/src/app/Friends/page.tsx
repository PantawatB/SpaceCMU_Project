...
export default function FriendsMainPage() {
  ...
  // ── Own market item management (when viewing own profile in Friends page) ──
  const handleMarkItemAsSold = async () => {
    ...
    try {
      ...
      setSelectedUserMarketItems((prev) =>
        prev.map((item) =>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-[900px] max-h-[85vh] overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row h-full overflow-y-auto">
              ...
              <div className="w-full md:w-1/2 p-8 flex flex-col">
                ...
                {/* Contact Seller Button / Owner actions */}
                {activeUser?.id === selectedMarketItem.seller.id ? (
                  /* ── เจ้าของสินค้า: แสดงปุ่มจัดการ ── */
